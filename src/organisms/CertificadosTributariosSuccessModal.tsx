...
interface CertificadosTributariosSuccessModalProps {
  isOpen: boolean;
  onPrimaryAction: () => void;
  onSecondaryAction: () => void;
}

export function CertificadosTributariosSuccessModal({
  isOpen,
  onPrimaryAction,
  onSecondaryAction,
}: CertificadosTributariosSuccessModalProps) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="certificados-tributarios-success-title"
    >
      <div
      ...
      >
        ...
        <h2
          id="certificados-tributarios-success-title"
