...
2. **Header** - "Iniciar sesi�n" title + instructions
3. **Form Fields**:
   - Tipo de documento (dropdown)
   - N�mero de documento (text input)
...
7. **Forgot Password Link** - "�Olvidaste tu contrase�a?"
...
- **Prehome** (00-prehome) - Contains "Iniciar Sesi�n" navigation link
